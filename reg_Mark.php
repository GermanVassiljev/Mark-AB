...
if (isset($_SESSION['username']) && isset($_SESSION['userid']))
    header("Location: ./mark_andmed.php");  // redirect the user to the home page
...
<form action="./reg_Mark.php" class="form" method="POST">
    ...
    <div class="">
        ...
        if (isset($success) && $success){
            echo '<p color="green">Yay!! Your account has been created. <a href="./ab_login_Mark.php">Click here</a> to login!<p>';
        }
    ...
    <p class="center"><br />
        Already have an account? <a href="ab_login_Mark.php">Login here</a>
    </p>
</form>
